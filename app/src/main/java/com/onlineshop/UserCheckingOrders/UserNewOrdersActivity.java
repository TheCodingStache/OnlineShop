package com.onlineshop.UserCheckingOrders;
...
public class UserNewOrdersActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Orders> options = new FirebaseRecyclerOptions.Builder<Orders>()
                ...
                .build();
        FirebaseRecyclerAdapter<Orders, UserOrdersViewHolder> adapter = new FirebaseRecyclerAdapter<Orders, UserOrdersViewHolder>(options) {
            @NonNull
            @Override
            ...
            @Override
            protected void onBindViewHolder(@NonNull UserOrdersViewHolder holder, final int position, @NonNull final Orders model) {
